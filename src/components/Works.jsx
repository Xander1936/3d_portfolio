    ...
    >
      ...
      >
        ...
        <div
          ...
          className="mt-5 text-justify cursor-pointer"
        >
...
// Before Run "npm install react-parallax-tilt" to install Tilt
const Works = () => {
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          Each project is briefly describe with links to code repositories and 
          live demon in it. It reflects my ability to solve complex problems, 
